...
void HardFault_Handler(void)
{
  ...
  uint32_t strlen;
    ...
    strlen = snprintf(str, 100, "HardFault! HFSR=0x%08X CFSR=0x%08X MMFAR=0x%08X BFAR=0x%08X\n",
           (unsigned)_HFSR, (unsigned)_CFSR, (unsigned)_MMFAR, (unsigned)_BFAR);
    HAL_UART_Transmit(&huart1, (uint8_t *)str, strlen, HAL_MAX_DELAY);
